...
# picture
rock_img = ImageTk.PhotoImage(Image.open("rock.jpeg"))
paper_img = ImageTk.PhotoImage(Image.open("paper.jpeg"))
scissor_img = ImageTk.PhotoImage(Image.open("scissors.jpeg"))
rock_img_comp = ImageTk.PhotoImage(Image.open("rock-user.jpeg"))
paper_img_comp = ImageTk.PhotoImage(Image.open("paper-user.jpeg"))
scissor_img_comp = ImageTk.PhotoImage(Image.open("scissors-user.jpeg"))
